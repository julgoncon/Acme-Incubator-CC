...
<acme:form>
	...
	<acme:form-checkbox code="authenticated.technologyRecord.form.label.openSource" path="openSource" readonly="true"/>
	<acme:form-double code="authenticated.technologyRecord.form.label.stars" path="stars"/>
