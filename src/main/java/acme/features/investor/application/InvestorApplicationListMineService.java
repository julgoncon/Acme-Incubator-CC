...
public class InvestorApplicationListMineService implements AbstractListService<Investor, Application> {
	...
	public void unbind(final Request<Application> request, final Application entity, final Model model) {
		...
		request.unbind(entity, model, "ticker", "status", "investmentOffer", "investmentRound.ticker");
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		Collection<Application> result = this.repository.findManyApplicationByInvestorId(InvestorId);
