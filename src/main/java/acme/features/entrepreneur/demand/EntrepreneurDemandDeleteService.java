...
@Service
public class EntrepreneurDemandDeleteService implements AbstractDeleteService<Entrepreneur, Demand> {
	...
	public boolean authorise(final Request<Demand> request) {
		...
		Demand demand = this.repository.findDemandByInvestmentRoundId(investmentId);
	...
	@Override
	public void delete(final Request<Demand> request, final Demand entity) {
		assert request != null;
		assert entity != null;
