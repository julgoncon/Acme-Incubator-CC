...
@Service
public class BookkeeperInvestmentRoundListAccountingRecordService implements AbstractListService<Bookkeeper, InvestmentRound> {
	...
	public Collection<InvestmentRound> findMany(final Request<InvestmentRound> request) {
		...
		Collection<InvestmentRound> result = this.repository.findManyAccountedByBookkeeperId(bookkeeperId);
